    ...
    <div class="container">
        ...
        <div class="main">
            <form method="post" action="ubah.php" enctype="multipart/form-data">
                ...
                <div class="input">
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Upload file gambar</label><br>
                        <input class="form-control" name="file_gambar" type="file" id="formFile" required value="<?= $data["gambar"]; ?>">
                    </div>
